    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private String getPreviewDate(LocalDate date) {
            ...
            if (period.getYears() != 0) {
                ...
                if (years > 0) {
                    return tvDate.getContext().getResources().getQuantityString(R.plurals.timeline_year, years, years);
                } else {
                    return tvDate.getContext().getResources().getQuantityString(R.plurals.timeline_year, -years, -years);
                }
                ...
                if (months > 0) {
                    return tvDate.getResources().getQuantityString(R.plurals.timeline_month, months, months);
                } else {
                    return tvDate.getResources().getQuantityString(R.plurals.timeline_month, -months, -months);
                }
                ...
                if (weeks > 0) {
                    return tvDate.getResources().getQuantityString(R.plurals.timeline_week, weeks, weeks);
                } else {
                    return tvDate.getResources().getQuantityString(R.plurals.timeline_week_later, -weeks, -weeks);
                }
            } else if (period.getDays() != 0) {
                int days = period.getDays();
                if (days > 0) {
                    return tvDate.getResources().getQuantityString(R.plurals.timeline_days, days, days);
                } else {
                    return tvDate.getResources().getQuantityString(R.plurals.timeline_days_later, -days, -days);
                }
            } else {
